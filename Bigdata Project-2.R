...
dataset<-read.table("C:/Users/nikhi/Downloads/abalone.data",stringsAsFactors = FALSE, sep=',')
dataset[1:12,1:9]
...
#KNN IMPLEMENTATION WITH DATA Split of 60-40
df2.norm.rows= nrow(df2.norm)
df2.norm.sample=0.6
df2.rows=df2.norm.rows*df2.norm.sample
df2.rows
...
df2.train_60<-df2.norm[df2.train.index,]
df2.train_60[1:15,]

df2.test_60<-df2.norm[-df2.train.index,]
dim(df2.test_60)
...
conf_matrix=df2.test_60.ct.k7$t
conf_matrix
...
#KNN IMPLEMENTATION WITH DATA Split of 50-50
df2.norm.rows= nrow(df2.norm)
df2.norm.sample=0.5
df2.rows=df2.norm.rows*df2.norm.sample
df2.rows
...
df2.train_50<-df2.norm[df2.train.index,]
df2.train_50[1:15,]

df2.test_50<-df2.norm[-df2.train.index,]
dim(df2.test_50)
...
conf_matrix=df2.test_50.ct.k7$t
conf_matrix
